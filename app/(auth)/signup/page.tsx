    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="w-full max-w-4xl bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div className="w-full p-8 flex flex-col justify-center text-center">
                ...
                <Link href="/signUpClient" className="w-full bg-green-600 text-white text-center py-2 px-4 rounded-lg hover:bg-green-700 flex items-center justify-center">
                ...
                <Link href="./signUpIndustrial" className="w-full bg-green-600 text-white text-center py-2 px-4 rounded-lg mt-4 hover:bg-green-700 flex items-center justify-center">
